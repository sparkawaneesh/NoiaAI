from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QGridLayout, QVBoxLayout, QHBoxLayout, QPushButton, QFrame, QLabel, QSizePolicy, QDesktopWidget
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "whose", "whom", "can you", "what's", "where's", "how's"]
...
def GraphicsDirectoryPath(Filename):
    Path = rf'{GraphicsDirectoryPath}\{Filename}'
    return Path
